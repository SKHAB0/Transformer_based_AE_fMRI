...
for i = 1:length(subjects)
    disp(['Starting preprocessing subject ' subjects{i} '...'])
    subject = subjects{i};
    ...
    if exist([folderPath_2 'y_' subject '_ses-01_T1w.nii'], 'file') ~= 2
        ...
        try
            ...
            disp(['Finished preprocessing subject ' subject]);
        catch
