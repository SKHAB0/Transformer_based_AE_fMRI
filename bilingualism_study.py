...
def train_model(embed_dim= embed_dim, 
    ...
    new_path = 'trained_models_bilingualism/' + model_type + '/' + position + '/' + layers
...
model_autocorr = torch.load('trained_models_bilingualism/Autocorr_Transformer/latent/32_16_4_2/trained_model_2heads_FE2_lambda-0.1_physical_Autocorr_Transformer.pth')
model_decomposition = torch.load('trained_models_bilingualism/Decomposition_Transformer/latent/32_16_4_2/trained_model_2heads_FE2_lambda-0.1_physical_Decomposition_Transformer.pth')
model_standard = torch.load('trained_models_bilingualism/Standard_Transformer/latent/32_16_4_2/trained_model_2heads_FE2_lambda-0.1_physical_Standard_Transformer.pth')
...
# plt.tight_layout()
# plt.savefig('figures/bilingualism/losses.png')
