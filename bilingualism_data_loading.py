...
def load_BILINGUILISM_data(batch_size = 32):

    subjects_tsv = pd.read_csv('BILINGUALISM/participants.tsv', sep='\t')
    ...
    for _, row in tqdm(subjects_tsv.iterrows()):
        ...
        path = 'BILINGUALISM/'+subject+'/BOLD_time_series.mat'
        try: 
